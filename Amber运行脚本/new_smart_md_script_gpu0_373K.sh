...
for (( i=0; i<${#STEPS}; i++ )); do
    ...
    case $step in
        1)
            ...
            # 替换为你要在当前目录执行的命令
            pwd
            bash /home/yons/wwm/4519_subtilisin_120ns_ace_aapfa_nme_HID/inputfiles_nvt_373k_md/md_min_heat_equil_gpu0.sh
            ;;
        2)
            echo ""
        ...
        3)
            ...
            for j in $(seq 1 3); do
                ...
                if [ -d "$md_dir" ]; then
                    ...
                    # 替换为你要在 md 子目录执行的命令
                    pwd
                    bash /home/yons/wwm/4519_subtilisin_120ns_ace_aapfa_nme_HID/inputfiles_nvt_373k_md/md_pro_gpu0.sh
                    popd > /dev/null
                else
