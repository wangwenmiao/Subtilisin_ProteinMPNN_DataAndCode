...
# 定义原子质量表
atomic_masses = {"H": 1.00784, "C": 12.0107, "N": 14.0067, "O": 15.999, "S": 32.065}
...
tleap_commands = [
    "source leaprc.gaff",
    "source /home/lab/softwares/amber/amber22/dat/leap/cmd/oldff/leaprc.ff14SB",
    "source leaprc.water.opc",
    "loadamberparams frcmod.ions1lm_126_tip3p",
    "Mpro = loadpdb eps.pdb",
    "set default PBRadii mbondi2",
    "saveamberparm Mpro Mpro.prmtop Mpro.inpcrd",
    "charge Mpro",
    # "addIons Mpro Cl- Na+ 18",
    "solvatebox Mpro TIP3PBOX 12.0",
    # "addIonsRand Mpro Na+ 20 Cl- 20",
    "saveamberparm Mpro Mpro_solvated.prmtop Mpro_solvated.inpcrd",
    "quit"
]
...
for index, cmd in enumerate(tleap_commands): 
    ...
    if cmd == "saveamberparm Mpro Mpro_solvated.prmtop Mpro_solvated.inpcrd":
        output = child.before
