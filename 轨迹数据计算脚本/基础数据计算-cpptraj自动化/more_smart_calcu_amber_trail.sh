...
trajin step8_prod_npt.nc 1 last
autoimage
rms first :protein_index@CA
average crdset AVG
run
...
run
rms ref AVG :protein_index@CA
projection evecs Evecs :protein_index@CA out pca_protein.dat beg 1 end 2
run"""
...
sasa_polar = """parm complex_solv.prmtop
trajin step8_prod_npt.nc
rms first :protein_index@CA
surf :protein_index@N,O out polar_surf_protein.dat
go"""

sasa_nopolar = """parm complex_solv.prmtop
trajin step8_prod_npt.nc
rms first :protein_index@CA
surf :protein_index@C* out nopolar_surf_protein.dat
go"""
...
"""
    ...
    'ligand_prmtop': ligand_prmtop,
    'complex_prmtop': complex_prmtop,
    'sasa_protein_nopolar': sasa_protein_nopolar,
    'sasa_protein_polar': sasa_protein_polar,
"""
...
# 定义所有可用的命令
declare -a COMMANDS=(
    "cpptraj -i ../inputfiles_calcu_trail/center.cpp"
    "mpirun -n 24 cpptraj.MPI -i ../inputfiles_calcu_trail/hbondw.cpp"
    "mpirun -n 24 cpptraj.MPI -i ../inputfiles_calcu_trail/hbondp.cpp"
    "cpptraj -i ../inputfiles_calcu_trail/stable.cpp"
    "cpptraj -i ../inputfiles_calcu_trail/rg.cpp"
    "mpirun -n 24 cpptraj.MPI -i ../inputfiles_calcu_trail/sasa_protein.cpp"
    "cpptraj -i ../inputfiles_calcu_trail/sasa_complex.cpp"
    "cpptraj -i ../inputfiles_calcu_trail/sasa_ligand.cpp"
    ...
    "bash ../inputfiles_calcu_trail/ligand_prmtop.cpp"
    "cpptraj -i ../inputfiles_calcu_trail/sasa_nopolar.cpp"
    "cpptraj -i ../inputfiles_calcu_trail/sasa_polar.cpp"
)
