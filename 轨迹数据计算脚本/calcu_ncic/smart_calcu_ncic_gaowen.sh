...
for idx in "${!dirs[@]}"; do
    ...
    for i in {1..3}; do
        ...
        if [[ -d "$md_dir" && "$md_dir" == *apo* ]]; then
            ...
            mpirun -n 24 cpptraj.MPI -i /home/yons/wwm/4519_subtilisin_120ns_ace_aapfa_nme_HID/calcu_ncic/ncic_apo_04nm_gaowen.in
            mpirun -n 24 cpptraj.MPI -i /home/yons/wwm/4519_subtilisin_120ns_ace_aapfa_nme_HID/calcu_ncic/ncic_apo_06nm_gaowen.in
